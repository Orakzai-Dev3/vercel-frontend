...
function Men_Shearling_Jacket() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            setLoading(true)
            const response = await fetch(`https://railway-backend-production-08c2.up.railway.app/men/shearling_jackets?color=${color}&size=${size}&price${price}&sort=${sort}`, {
              method: "GET",
                headers: {
  ...
  return (
    ...
    <div className=' '>
        ...
        <div onClick={()=>setShow(!show)} className=' h-full w-full'>
            ...
            <div className='flex flex-col gap-1 my-4'>
                <h1 className='tracking-tighter cursor-pointer hover:font-semibold duration-500'>Men Shearling Leather Jackets
                (13)</h1>
                <h1 className='tracking-tighter cursor-pointer hover:font-semibold duration-500'>Women Shearling Leather Jackets
                (6)</h1>
            </div>
            </div>
            <div>
    ...
    <div>
        <img className='hidden lg:block' src="https://cdn.leatherscin.com/img/plpbanner/men-shearling-leather-jackets-banner-2024.webp" alt="" />
        <img className='block lg:hidden w-full' src="https://cdn.leatherscin.com/img/plpbanner/men-shearling-leather-jackets-banner-2024-mobile.webp" alt="" />
    </div>
    <div className='max-w-[85vw] m-auto flex gap-8'>
        ...
        <div className=' w-full lg:basis-[80%]'>
            <div className='flex flex-col lg:flex-row justify-between my-2'>
                ...
                <h1 className='text-xl xl:text-2xl py-2 lg:py-1 text-[#552c1a] underline font-semibold tracking-tighter'> MEN SHEARLING LEATHER JACKETS</h1>
  ...
  <h1 class="text-3xl md:text-4xl font-semibold text-center mb-6 text-[#522917]">
    Premium Men's Shearling Leather Jackets by SCIN
  </h1>
  
  <p class="text-base md:text-lg text-center mb-6 text-gray-600 leading-relaxed">
    Experience the perfect blend of rugged style and luxurious comfort with SCIN's men's shearling leather jackets. Crafted from 100% premium lambskin leather, our shearling jackets offer exceptional warmth, durability, and timeless appeal. These versatile pieces transition effortlessly from weekend casual to polished workwear, providing superior insulation with unmatched style. Explore our collection featuring various designs including bomber and aviator styles in multiple colors and sizes - the ultimate winter wardrobe essential that combines functionality with fashion.
  </p>

  <h2 class="text-2xl md:text-3xl font-semibold text-center mb-4 text-[#522917]">
    Signature Shearling Jacket Styles
  </h2>
  
  <p class="text-base md:text-lg text-center mb-6 text-gray-600 leading-relaxed">
    Discover SCIN's exclusive range of shearling jacket designs:
    <ul class="list-disc pl-6 text-gray-600 space-y-2 mb-6">
      <li><span class="font-semibold">B3 Aviator Jacket:</span> Brown shearling beauty blending modern comfort with classic luxury</li>
      <li><span class="font-semibold">RAF Bomber Jacket:</span> Black military-inspired design with thick shearling lining</li>
      <li><span class="font-semibold">Gary Aviator Jacket:</span> Brown-hued statement piece with tough yet chic appeal</li>
      <li><span class="font-semibold">A2 Bomber Jacket:</span> Ultra-durable military style combining warmth and elegance</li>
    </ul>
    Layer these premium jackets with everything from animal-print pants to classic jeans for looks that turn heads while keeping you cozy.
  </p>
  ...
  <p class="text-base md:text-lg text-center text-gray-600 leading-relaxed">
    Create versatile looks with our shearling jackets:
    <ul class="list-disc pl-6 text-gray-600 space-y-2">
      <li><span class="font-semibold">Vintage Cool:</span> Pair with flannel and denim for retro appeal</li>
      <li><span class="font-semibold">Adventure Ready:</span> Combine with canvas pants and hiking boots</li>
      <li><span class="font-semibold">Rustic Charm:</span> Style with corduroy and raw denim</li>
      <li><span class="font-semibold">Urban Edge:</span> Team with graphic tees and slim-fit chinos</li>
    </ul>
    Visit SCIN today to explore our complete collection of authentic shearling leather jackets and elevate your winter wardrobe with these investment pieces that only get better with age.
  </p>
</div>
    </>
  )
...
export default Men_Shearling_Jacket
