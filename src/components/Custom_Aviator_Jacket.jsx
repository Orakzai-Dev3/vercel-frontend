...
import Custom_coat_And_Blazer from './Custom_coat_And_Blazer';
function  Custom_Aviator_Jacket() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          ...
          try {
            const response = await fetch(`https://railway-backend-production-08c2.up.railway.app/men/custom-aviator-jacket?color=${color}&size=${size}&price${price}&sort=${sort}`, {
              method: "GET",
                headers: {
  ...
  return (
    ...
    <div>
        <img className='hidden lg:block' src="https://cdn.leatherscin.com/img/plpbanner/aviator-leather-jackets.webp" alt="" />
        <img className='block lg:hidden w-full' src="https://cdn.leatherscin.com/img/plpbanner/aviator-leather-jackets-mobile.webp" alt="" />
    </div>
    <div className='max-w-[85vw] m-auto flex gap-8'>
        <div className='hidden lg:block basis-[20%]'>
            ...
            <h1 className='text-lg font-semibold border-b-2 border-[#cA9154]'>Categories</h1>
            <div className='flex flex-col gap-1 my-4'>
                <h1 className='tracking-tighter cursor-pointer hover:font-semibold duration-500'> Aviator Leather Jackets
                ({(data.length)})</h1>
                <h1 className='tracking-tighter cursor-pointer hover:font-semibold duration-500'> Aviator Leather Jackets
                (6)</h1>
            </div>
        ...
        <div className=' w-full lg:basis-[80%]'>
            <div className='flex flex-col lg:flex-row justify-between my-2'>
                ...
                <h1 className='text-xl xl:text-2xl py-2 lg:py-1 text-[#552c1a] underline font-semibold tracking-tighter'>AVIATOR LEATHER JACKETS</h1>
...
export default Custom_Aviator_Jacket
