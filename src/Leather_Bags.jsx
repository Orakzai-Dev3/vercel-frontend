...
function Corporate_gift() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            setLoading(true)
            const response = await fetch(`https://railway-backend-production-08c2.up.railway.app/men//leather-bags?color=${color}&size=${size}&price${price}&sort=${sort}`, {
              method: "GET",
                headers: {
  ...
  return (
    ...
    <div className=' '>
        ...
        <div onClick={()=>setShow(!show)} className=' h-full w-full'>
            ...
            <div className='flex flex-col gap-1 my-4'>
                <h1 className='tracking-tighter cursor-pointer hover:font-semibold duration-500'>Leather Bags
                (13)</h1>
    ...
    <div>
        <img className='hidden lg:block' src="https://cdn.leatherscin.com/img/plpbanner/leather-bags-banner-2024.webp" alt="" />
        <img className='block lg:hidden w-full' src="https://cdn.leatherscin.com/img/plpbanner/leather-bags-banner-2024-mobile.webp" alt="" />
    </div>
    <div className='max-w-[85vw] m-auto flex gap-8'>
        ...
        <div className=' w-full lg:basis-[80%]'>
            <div className='flex flex-col lg:flex-row justify-between my-2'>
                ...
                <h1 className='text-xl xl:text-2xl py-2 lg:py-1 text-[#552c1a] underline font-semibold tracking-tighter'>LEATHER BAGS</h1>
    ...
    <div class="w-[90vw] mx-auto my-8 p-6 bg-white shadow-lg rounded-lg">
  
  <h1 class="text-3xl md:text-4xl font-bold text-center mb-6 text-gray-800">
    Shop Precisely Crafted Leather Bags by SCIN
  </h1>
  
  
  <p class="text-base md:text-lg text-center mb-6 text-gray-600 leading-relaxed">
    Indulge in the beauty of classic and functional leather bags by SCIN, designed to add a touch of uniqueness to your wardrobe. Made with real, full grain leather, these leather bags are designed to stand the test of time. Explore the various styles that we offer including all from leather toiletry bags and leather duffle bags to leather handbags and leather backpacks. Whether you are a travel enthusiast, a professional, or a student, you will find a range of styles in our selection of leather bags for men and women to choose from. Shop now and let your leather bag a style statement!
  </p>
  
  
  <h2 class="text-2xl md:text-3xl font-semibold text-center mb-4 text-gray-700">
    Get the Most Unique Styles in Our Leather Bags for Women
  </h2>
  
 
  <p class="text-base md:text-lg text-center mb-6 text-gray-600 leading-relaxed">
    SCIN brings you an extraordinary collection of leather bags for women, available in trendy and classic styles and colors. Hop on the trend or become one with our luxurious collection, featuring many bold and bright colors, as well as subtle and classic ones. Every leather bag you see at SCIN symbolizes style and versatility and is made with precision and dedication by our experts. From classic to contemporary designs, each leather bag is crafted to complement the modern lifestyle of today's woman. Browse our collection and add this luxurious and fashionable accessory to your wardrobe that will speak volumes!
  </p>
  
  
  <h2 class="text-2xl md:text-3xl font-semibold text-center mb-4 text-gray-700">
    Durable and Versatile Leather Bags for Men
  </h2>
  
  
  <p class="text-base md:text-lg text-center text-gray-600 leading-relaxed">
    Add a durable accessory to your wardrobe that will last you for decades - SCIN's premium leather bags for men! Made with real leather sourced from sheepskin, goatskin and cowhide, each leather bag offers durability and versatility, making your leather bag a lasting addition to your bags collection. SCIN's leather bags capture the essence of vintage era, bringing you a leather bag featuring the modern style, while carrying the legacy of the old classics. Choose your favorite colors from the collection, starting from the classic black and versatile brown to shades of tan and gray, and get a leather bag that will make you stand out with uniqueness!
  </p>
</div>
